...
class meta_DTI_MAML(nn.Module):
    def __init__(self,args):
        ...
        self.chem_dict = pd.Series(load_json('../data/ChEMBLE26/chemical/ikey2smiles_ChEMBLE.json'))
        self.protein_dict = pd.Series(load_pkl('../data/ChEMBLE26/protein/unipfam2triplet.pkl'))
        ...
        if all_config['phase1ResiDist'] != 'none':
            ...
            model_interResiDist = interResidue_distMtx_classifier(dim=dim,
                                                                  ...
                                                                  frozen='none')
            path = '../data/distance/residue-residue/model-chosen/' + 'DISAE' + '-' + 'none' + '-' + \
        ...
        if all_config['phase2DTIDist'] != 'none':
            ...
            path =  '../data/distance/residue-ligand/model-chosen/' + 'DISAE' + '-' + 'none' + '-' + \
